...
\section{Matèriels et méthodes}\label{matuxe8riels-et-muxe9thodes}

\begin{itemize}
\tightlist
\item
  Présentation du site de Paracou (Gourlet-Fleury et al. 2004).
\end{itemize}
...
\tightlist
\item
  Présentation du site de BCI (Raby 2017).
\end{itemize}
...
\begin{itemize}
\item
  Nombres de Hill (1973)
\item
  Les analyses sont réalisées avec \emph{R} (R Core Team 2026) et le
  package \emph{divent} (Marcon et Puech under review).
\end{itemize}
...
(courbe bleue)\ldots{} (dernière modification)}
